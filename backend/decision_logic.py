...
class DecisionLogic:
    ...
    def majority_vote(self, 
        ...
        # Require a majority of recent windows to be at least low confidence
        above_low_count = sum(1 for p in recent_probs if p >= self.low_conf_thresh)
        required_majority = (self.vote_windows // 2) + 1

        is_candidate = above_low_count >= required_majority
